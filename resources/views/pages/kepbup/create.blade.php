...
@section('title', 'Tambah Data Keputusan Bupati | Kesbangpol Lebak')
@section('sub-judul', 'Tambah Data Kepbup')
@section('content')
<section class="content">
	<div class="container-fluid">
		<div class="card">
			...
			<form action="{{route('kepbup.store')}}" method="POST" enctype="multipart/form-data">
				@csrf
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
