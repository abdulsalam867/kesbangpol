...
@section('title', 'Tambah Data Organisasi Kemasyarakatan | Kesbangpol Lebak')
@section('sub-judul', 'Tambah Data Ormas')
@section('content')
<section class="content">
	<div class="container-fluid">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{route('ormas.store')}}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="row">
						<div class="col-md-7">
							...
							<div class="form-group">
								<input name="nama" type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Nama Ormas">
								@error('nama')
								<div class="invalid-feedback">{{$message}}</div>
								@enderror
							</div>
