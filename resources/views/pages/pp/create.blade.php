...
@section('title', 'Tambah Data Peraturan Pemerintah | Kesbangpol Lebak')
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="nomor">Peraturan Pemerintah Nomor</label>
							...
							<div class="form-group">
								<label for="tentang">Peraturan Pemerintah Tentang</label>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>Peraturan Pemerintah Tahun</label>
