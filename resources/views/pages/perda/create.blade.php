...
@section('title', 'Tambah Data Peraturan Daerah | Kesbangpol Lebak')
@section('sub-judul', 'Tambah Data Perda')
@section('content')
<section class="content">
	<div class="container-fluid">
		<div class="card">
			...
			<form action="{{route('perda.store')}}" method="POST" enctype="multipart/form-data">
				@csrf
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="nomor">Peraturan Daerah Nomor</label>
							...
							<div class="form-group">
								<label for="tentang">Peraturan Daerah Tentang</label>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>Peraturan Daerah Tahun</label>
