...
@section('title', 'Tambah Data Regulasi Lainnya | Kesbangpol Lebak')
@section('sub-judul', 'Tambah Data Regulasi')
@section('content')
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="nomor">Regulasi Nomor</label>
							...
							<div class="form-group">
								<label for="tentang">Regulasi Tentang</label>
