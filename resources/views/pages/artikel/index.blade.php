...
@section('title', 'Artikel | Kesbangpol Lebak')
	...
	<div class="container-fluid">
		<div class="card">
			<div class="card-header">
				<a href="{{route('post.create')}}" class="btn bg-gradient-primary btn-xs float-right">
								...
								<div class="btn-group">
									...
									<div class="dropdown-menu dropdown-menu-right" role="menu" style="font-size: 12px; width: 20px;">
										<form action="{{ route('post.destroy', $hasil->id) }}" method="POST">
											@csrf
											@method('delete')
											<a href="{{ route('post.edit', $hasil->id) }}" class="dropdown-item text-success"><i class="fas fa-edit"></i> Edit</a>
